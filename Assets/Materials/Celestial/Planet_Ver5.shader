		...
		SubShader
		{
			...
			CGINCLUDE
				...
				half3 terrainColor(const float3 p, const float3 lig, const float dist) {
					...
					const half3 ambColor = lerp(atmo * night, half3(0.015, 0.08, 0.1), 0.1);
			...
			/*Pass
			{
				...
				#include "UnityCG.cginc"
				// yes, I know the vertex function is missing
